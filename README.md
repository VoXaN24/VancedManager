...
After 3 months of development, we are finally ready to Introduce [Vanced Manager](https://github.com/voxan24/VancedManager) to the masses!!
...
## Contributions
Pull Requests should be made to the [Dev](https://github.com/voxan24/VancedManager) Branch as that is the working branch, master is for Release code only.


## TODO
- [ ] Finish the rebranding and change the apk info
## Building
